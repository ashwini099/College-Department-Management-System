  ...
  <script type="text/javascript">
    $(document).ready(function(){
      $("edit_profile").click(function(){
        $("#main_content").load('editProfile.php');
      });
...
<div class="col-md-2" id="left_sidebar">
 ...
 <a href="/loginsystem/edi.php"> <button type="submit" class="btn btn-primary btn-lg  mx-4 px-4" id="edit_profile">Edit Profile</button></a>
...
<div class="container my-3">
    <div class="alert alert-success" role="alert">
      ...
      <p>Hey how are you doing? Welcome to iSecure. You are logged in as <?php echo $_SESSION['email']?>.</p>
      <hr>
...
<div class="container my-3">
    <div class="alert alert-success" role="alert">
      <h4 class="alert-heading">Assignment - <?php echo $_SESSION['email']?></h4>
...
<div class="container my-3">
    <div class="alert alert-success" role="alert">
      <h4 class="alert-heading">Notices - <?php echo $_SESSION['email']?></h4>
      <p>Hey how are you doing? Welcome to iSecure. You are logged in as <?php echo $_SESSION['email']?>. Aww yeah, you successfully read this important alert message. 
      This example text is going to run a bit longer so that you can see how spacing within an alert works with this kind of content.</p>
      <hr>
      <p class="mb-0">Whenever you need to, be sure to logout <a href="/loginsystem/logout.php"> using this link.</a></p>
...
<div class="container my-3">
    <div class="alert alert-success" role="alert">
      <h4 class="alert-heading">Result - <?php echo $_SESSION['email']?></h4>
      <p>Hey how are you doing? Welcome to iSecure. You are logged in as <?php echo $_SESSION['email']?>. Aww yeah, you successfully read this important alert message. 
      This example text is going to run a bit longer so that you can see how spacing within an alert works with this kind of content.</p>
      <hr>
      <p class="mb-0">Whenever you need to, be sure to logout <a href="/loginsystem/logout.php"> using this link.</a></p>
